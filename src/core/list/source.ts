import { FormItemConfig } from './index.d'

export const source = {
  searchForm: (chilren: FormItemConfig[] ): string =>`
...
function SearchForm(props: SearchFormProps) {
  ...
  const formConfigs as FormItemProps = ${JSON.stringify(chilren)}
  return (
    <Form
      layout="inline"
